...
folder are mapped to the application's root namespace, 'Thesis'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Thesis' in the same way
as `"Thesis/sass/src"`.
